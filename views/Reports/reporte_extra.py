...
class ReporteExtra(tk.Frame,):
    ...
    def generar_reporte_ventas_marca_ventas_mensuales(self):
        ...
        doc = SimpleDocTemplate("reporte_extra.pdf", pagesize=letter)
        

        elements = []

        elements.append(Paragraph("Reporte ventas por marca e ingrasos mensuales"))
        ...
        ax2.set_xticks(range(len(df['Mes'])))  # Esto asegura que las etiquetas estén en las posiciones correctas
